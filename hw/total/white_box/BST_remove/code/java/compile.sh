...
java -jar /usr/share/java/checkstyle-7.0-all.jar -c /google_checks.xml removeTest.java > codestyle #Just change the java file. If more than one, add all to this single command.
